...
getfont:
	curl -Lo ./src/original/ionicons.svg --create-dirs https://raw.githubusercontent.com/driftyco/ionicons/3.0/dist/fonts/ionicons.svg

dump:
	rm -rf ./src/svg/
	mkdir ./src/svg/
	./node_modules/.bin/svg-font-dump -c `pwd`/config.yml -f -i ./src/original/ionicons.svg -o ./src/svg/ -d diff.yml
...
.PHONY: font html dist dump gh-pages dependencies getfont
